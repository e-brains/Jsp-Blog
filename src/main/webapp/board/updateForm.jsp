<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.kye.blog.domain.user.User"%>
...
<div class="container">
	<form action="/blog/board?cmd=update" method="POST">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" placeholder="title" id="title" name="title"  value="${requestScope.dto.title}" />
		</div>
	
		<div class="form-group">
			<label for="content">Content:</label>
			<textarea id="summernote" class="form-control" rows="5" id="content" name="content">
				${requestScope.dto.content} <!-- content는 value가 없다. -->
			</textarea>
		</div>
